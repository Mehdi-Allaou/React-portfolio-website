...
export const Text = () => {
  ...
  I have ever since high school been drawn to computers and code. I managed to start the pursuit for my passion in the beginning of 2020, learning at first via courses on Udemy and Codecademy and later enrolling in a programming course by Lexicon. I'm glad that you are here so you can get to know me a little bit better and explore some of my projects, so don't miss checking them out!`;
  return (
    <>
      {firstInfo}
